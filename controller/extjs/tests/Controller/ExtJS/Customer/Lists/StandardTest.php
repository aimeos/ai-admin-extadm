...
class StandardTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->object = new \Aimeos\Controller\ExtJS\Customer\Lists\Standard( \TestHelperExtjs::getContext() );
	}
	...
	public function testSaveDeleteItem()
	{
		...
		$textManager = new \Aimeos\Controller\ExtJS\Customer\Standard( \TestHelperExtjs::getContext() );
		...
		$listTypeManager = \Aimeos\Controller\ExtJS\Customer\Lists\Type\Factory::createController( \TestHelperExtjs::getContext() );
