...
{
	/**
	 * Creates a new price lists type controller object.
	 *
	...
	{
		/** controller/extjs/price/lists/type/name
		 ...
		 *
		 *  \Aimeos\Controller\ExtJS\Price\Lists\Type\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\ExtJS\Price\Lists\Type\Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  controller/extjs/price/lists/type/name = Mytype
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/extjs/price/lists/type/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Controller\\ExtJS\\Price\\Lists\\Type\\' . $name : '<not a string>';
		...
		$classname = '\\Aimeos\\Controller\\ExtJS\\Price\\Lists\\Type\\' . $name;
		 ...
		 * ("\Aimeos\Controller\ExtJS\Price\Lists\Type\Decorator\*") around the ExtJS controller.
		 *
		 *  controller/extjs/price/lists/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Controller\ExtJS\Price\Lists\Type\Decorator\Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
