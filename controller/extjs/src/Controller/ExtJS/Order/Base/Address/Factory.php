...
{
	/**
	 * Creates a new order base address controller object.
	 *
	...
	{
		/** controller/extjs/order/base/address/name
		 ...
		 *
		 *  controller/extjs/order/base/address/name = Myaddress
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/extjs/order/base/address/name', 'Standard' );
		}
		...
		/** controller/extjs/order/base/address/decorators/excludes
		 * Excludes decorators added by the "common" option from the order base address ExtJS controllers
		 *
		 ...
		 * @see controller/extjs/order/base/address/decorators/global
		 * @see controller/extjs/order/base/address/decorators/local
		 */

		/** controller/extjs/order/base/address/decorators/global
		 * Adds a list of globally available decorators only to the order base address ExtJS controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * @category Developer
		 * @see controller/extjs/common/decorators/default
		 * @see controller/extjs/order/base/address/decorators/excludes
		 * @see controller/extjs/order/base/address/decorators/local
		 */

		/** controller/extjs/order/base/address/decorators/local
		 * Adds a list of local decorators only to the order base address ExtJS controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * @see controller/extjs/order/base/address/decorators/global
		 */
		return self::addControllerDecorators( $context, $controller, 'order/base/address' );
	}
}
