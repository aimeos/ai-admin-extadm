...
{
	/**
	 * Creates a new order controller object.
	 *
	...
	public static function createController( \Aimeos\MShop\Context\Item\Iface $context, $name = null )
	{
		 ...
		 *
		 *  \Aimeos\Controller\ExtJS\Order\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\ExtJS\Order\Myorder
		 *
		...
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Controller\\ExtJS\\Order\\' . $name : '<not a string>';
		...
		$classname = '\\Aimeos\\Controller\\ExtJS\\Order\\' . $name;
		 ...
		 * ("\Aimeos\Controller\ExtJS\Order\Decorator\*") around the ExtJS controller.
		 *
		 *  controller/extjs/order/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Controller\ExtJS\Order\Decorator\Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
