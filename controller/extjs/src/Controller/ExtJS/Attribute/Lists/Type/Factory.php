...
{
	/**
	 * Creates a new attribute lists type controller object.
	 *
	...
	{
		/** controller/extjs/attribute/lists/type/name
		 ...
		 *
		 *  \Aimeos\Controller\ExtJS\Attribute\Lists\Type\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\ExtJS\Attribute\Lists\Type\Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  controller/extjs/attribute/lists/type/name = Mytype
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/extjs/attribute/lists/type/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Controller\\ExtJS\\Attribute\\Lists\\Type\\' . $name : '<not a string>';
		...
		$classname = '\\Aimeos\\Controller\\ExtJS\\Attribute\\Lists\\Type\\' . $name;

		$controller = self::createControllerBase( $context, $classname, $iface );

		/** controller/extjs/attribute/lists/type/decorators/excludes
		 ...
		 *
		 *  controller/extjs/attribute/lists/type/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see controller/extjs/attribute/lists/type/decorators/global
		 * @see controller/extjs/attribute/lists/type/decorators/local
		 */

		/** controller/extjs/attribute/lists/type/decorators/global
		 ...
		 *
		 *  controller/extjs/attribute/lists/type/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see controller/extjs/common/decorators/default
		 * @see controller/extjs/attribute/lists/type/decorators/excludes
		 * @see controller/extjs/attribute/lists/type/decorators/local
		 */

		/** controller/extjs/attribute/lists/type/decorators/local
		 ...
		 * ("\Aimeos\Controller\ExtJS\Attribute\Lists\Type\Decorator\*") around the ExtJS controller.
		 *
		 *  controller/extjs/attribute/lists/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Controller\ExtJS\Attribute\Lists\Type\Decorator\Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
		 ...
		 * @see controller/extjs/attribute/lists/type/decorators/global
		 */
		return self::addControllerDecorators( $context, $controller, 'attribute/lists/type' );
	}
}
