	...
	implements \Aimeos\Controller\ExtJS\Common\Iface
{
	...
	public function getItemSchema()
	{
		...
		$properties['attribute.lists.type'] = array(
			'description' => 'Attribute list type code',
			'optional' => false,
			'type' => 'string',
		);
		$properties['attribute.lists.typename'] = array(
			'description' => 'Attribute list type name',
			'optional' => false,
			'type' => 'string',
		);
	...
	protected function getManager()
	{
		if( $this->manager === null ) {
			$this->manager = \Aimeos\MShop\Factory::createManager( $this->getContext(), 'attribute/lists' );
		}
