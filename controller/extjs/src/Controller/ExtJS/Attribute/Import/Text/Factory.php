...
{
	/**
	 * Creates a new attribute import text controller object.
	 *
	...
	{
		/** controller/extjs/attribute/import/text/name
		 * Class name of the used ExtJS attribute import text controller implementation
		 *
		 ...
		 *
		 *  \Aimeos\Controller\ExtJS\Attribute\Import\Text\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\ExtJS\Attribute\Import\Text\Mytext
		 *
		 * then you have to set the this configuration option:
		 *
		 *  controller/extjs/attribute/import/text/name = Mytext
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/extjs/attribute/import/text/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Controller\\ExtJS\\Attribute\\Import\\Text\\' . $name : '<not a string>';
		...
		$classname = '\\Aimeos\\Controller\\ExtJS\\Attribute\\Import\\Text\\' . $name;
