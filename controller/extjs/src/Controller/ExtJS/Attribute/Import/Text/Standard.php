	...
	implements \Aimeos\Controller\ExtJS\Common\Load\Text\Iface
{
	...
	public function uploadFile( \stdClass $params )
	{
		...
		$result = (object) array(
			...
			'items' => array(
				(object) array(
					'job.label' => 'Attribute text import: ' . $clientFilename,
	...
	public function importFile( \stdClass $params )
	{
		...
		foreach( $items as $path )
		{
			...
			/** controller/extjs/attribute/import/text/standard/container/type
			 ...
			 * @category Developer
			 * @category User
			 * @see controller/extjs/attribute/import/text/standard/container/format
			 */

			/** controller/extjs/attribute/import/text/standard/container/format
			 ...
			 * @category Developer
			 * @category User
			 * @see controller/extjs/attribute/import/text/standard/container/type
			 * @see controller/extjs/attribute/import/text/standard/container/options
			 */

			/** controller/extjs/attribute/import/text/standard/container/options
