	...
	implements \Aimeos\Controller\ExtJS\Common\Iface
{
	...
	{
		parent::__construct( $context, 'Product_Lists_Type' );
	}
	...
	protected function getManager()
	{
		if( $this->manager === null ) {
			$this->manager = \Aimeos\MShop\Factory::createManager( $this->getContext(), 'product/lists/type' );
		}
