...
{
	/**
	 * Creates a new product import text controller object.
	 *
	...
	{
		/** controller/extjs/product/import/text/name
		 ...
		 *
		 *  controller/extjs/product/import/text/name = Mytext
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'controller/extjs/product/import/text/name', 'Standard' );
		}
