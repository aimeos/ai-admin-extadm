...
/**
 * ExtJS tag type controller for admin interfaces.
 *
 * @package Controller
 * @subpackage ExtJS
 */
	...
	implements \Aimeos\Controller\ExtJS\Common\Iface
{
	...
	/**
	 * Initializes the tag type controller.
	 *
	 * @param \Aimeos\MShop\Context\Item\Iface $context MShop context object
	 */
	public function __construct( \Aimeos\MShop\Context\Item\Iface $context )
	{
		parent::__construct( $context, 'Tag_Type' );
	}
	...
	protected function getManager()
	{
		if( $this->manager === null ) {
			$this->manager = \Aimeos\MShop\Factory::createManager( $this->getContext(), 'tag/type' );
		}
